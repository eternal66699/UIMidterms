...
public class ButtonsManager : MonoBehaviour
{
    ...
    {
        imageToScale.transform.localScale = Vector3.one; 
        imageToScale.transform.localPosition = originalPosition; 
        imageToScale.transform.rotation = Quaternion.identity; 
        imageToScale.color = originalColor; 
    }

    private void Start()
    {
        originalPosition = imageToScale.transform.localPosition;
        originalColor = imageToScale.color;
    }
    public void Zoom()
    {
